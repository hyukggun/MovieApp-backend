...
// HasUserPosts applies the HasEdge predicate on the "userPosts" edge.
func HasUserPosts() predicate.User {
...
// HasUserPostsWith applies the HasEdge predicate on the "userPosts" edge with a given conditions (other predicates).
func HasUserPostsWith(preds ...predicate.UserPost) predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := newUserPostsStep()
