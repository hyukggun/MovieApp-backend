...
type UserEdges struct {
	// UserPosts holds the value of the userPosts edge.
	UserPosts []*UserPost `json:"userPosts,omitempty"`
...
func (e UserEdges) UserPostsOrErr() ([]*UserPost, error) {
	...
	return nil, &NotLoadedError{edge: "userPosts"}
}
...
// QueryUserPosts queries the "userPosts" edge of the User entity.
