...
// ClearUserPosts clears all "userPosts" edges to the UserPost entity.
func (uu *UserUpdate) ClearUserPosts() *UserUpdate {
	uu.mutation.ClearUserPosts()
	return uu
}

// RemoveUserPostIDs removes the "userPosts" edge to UserPost entities by IDs.
func (uu *UserUpdate) RemoveUserPostIDs(ids ...int) *UserUpdate {
	uu.mutation.RemoveUserPostIDs(ids...)
	return uu
}

// RemoveUserPosts removes "userPosts" edges to UserPost entities.
